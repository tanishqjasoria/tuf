...
class TestFormats(unittest.TestCase):
  ...
  def test_build_dict_conforming_to_schema(self):
    ...
    with self.assertRaises(tuf.FormatError):
      tuf.formats.build_dict_conforming_to_schema(
          ...
          roles=roledict,
          consistent_snapshot=consistent_snapshot,
          compression_algorithms=bad_compression_algorithms)
  ...
  def test_expected_meta_rolename(self):
    ...
    self.assertRaises(tuf.FormatError, expected_rolename, tuf.formats.ROOT_SCHEMA)
  ...
  def test_check_signable_object_format(self):
    ...
    self.assertRaises(tuf.FormatError, check_signable, tuf.formats.ROOT_SCHEMA)
  ...
  def test_encode_canonical(self):
    ...
    # Test conditions for invalid arguments.
    self.assertRaises(tuf.FormatError, encode, tuf.formats.ROOT_SCHEMA)
